...
export function useCreateAdmin() {
  ...
  return useMutation({
    ...
    onError: (err) => {
      const msg = err instanceof Error ? err.message : "ایجاد ادمین ناموفق بود";
      toast.error(msg);
    },
  });
}
...
export function useUpdateAdmin(id: string) {
  ...
  return useMutation({
    ...
    onError: (err) => {
      const msg = err instanceof Error ? err.message : "ویرایش ناموفق بود";
      toast.error(msg);
    },
  });
}
...
export function useDeleteAdmin() {
  ...
  return useMutation({
    ...
    onError: (err) => {
      const msg = err instanceof Error ? err.message : "حذف ناموفق بود";
      toast.error(msg);
    },
  });
}
